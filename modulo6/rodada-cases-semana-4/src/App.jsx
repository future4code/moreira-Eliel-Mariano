...
import {Container, Main,SectionRight,Mensagem,SelectSorteios,InfoSorteios} from "./styled";
...
const App = () => {
  ...
  useEffect(() => {urlBase.get("/loterias")
      .then((response) => {
  ...
  useEffect(() => {urlBase.get("/loterias-concursos")
      .then((response) => {
  ...
  useEffect(() => {urlBase.get(`/concursos/${concursoId[0]}`)
      .then((response) => {
